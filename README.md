# Filmorate
Приложение включает в себя возможности ведения каталога фильмов, поиска по нему, проставления оценки и лайков, обмена мнением по фильмам, получения
автоматических рекомендаций топ-фильмов к просмотру, пользователи могут добавлять друг друга в друзья.
