...
public class FilmService {
    ...
    public Film update(Film newFilm) {
        ...
        filmDao.delAllLinkFilmLikes(oldFilm.getId());
    ...
    public void addLike(Long filmId, Long userId) {
        ...
        filmDao.addLinkFilmLikes(filmId, userIds);
    ...
    public void deleteLike(Long filmId, Long userId) {
        ...
        filmDao.delLinkFilmLikes(filmId, userId);
    ...
    private void addLinkFilmGenresAndLikes(Film film) {
        ...
        filmDao.addLinkFilmLikes(film.getId(), userIds);
    }
}
